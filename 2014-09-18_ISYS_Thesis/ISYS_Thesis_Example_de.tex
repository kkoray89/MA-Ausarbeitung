...
\title{Dies soll eine großartige Arbeit werden mit einem extrem langen Titel}
\subtitle{Manche Arbeiten haben sogar einen Untertitel}
% title in foreign language (german or english, depending on the language of the thesis)
\foreigntitle{This shall be a great thesis paper with an extremely long title}
\foreignsubtitle{Some theses even have subtitles}

\author{Max Mustermann}
\major{Technische Kybernetik}
%\date{01.08.2000}		% use either ISO format YYYY-MM-DD or german format DD.MM.YYYY
