...
\usepackage{svg} % um SVGs direkt einbinden zu können
\usepackage{tikz}
\usepackage{pgfplots} 
\usepackage{pgfgantt}
...
\usepackage[style=numeric,
						...
						bibencoding=utf8,	% .bib file in latin1 or utf8 encoding?
...
\foreigntitle{Estimation Methods for Adaptive Control of Hybrid Gearboxes}
